...
const App: React.FC = () => {
  const { isConnected, attacks, totalAttacks } = useSocket();
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/2/2b/Check_Point_Software_Technologies_logo.svg" alt="Logo" style={{ height: 36, marginRight: 16 }} />
      </div>
      {/* Main Content */}
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, background: '#181c2b', borderRadius: 12, padding: 16, color: '#fff', opacity: 0.95, overflowY: 'auto', boxShadow: '0 0 16px #00eaff22' }}>
            <AttackList attacks={attacks} />
          </div>
        </div>
        {/* Main Map Area */}
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative', background: '#10131f', minWidth: 0, alignItems: 'center', minHeight: 0 }}>
