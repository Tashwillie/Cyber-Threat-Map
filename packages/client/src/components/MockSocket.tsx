...
export const useMockSocket = () => {
  ...
  useEffect(() => {
    ...
    // Generate initial attacks (100 attacks for visual impact)
    const initialAttacks: AttackEvent[] = [];
    for (let i = 0; i < 100; i++) { // 100 attacks as requested
    ...
    const interval = setInterval(() => {
      ...
      setAttacks(prev => {
        const updated = [...prev.slice(-99), newAttack]; // Keep last 100 attacks
